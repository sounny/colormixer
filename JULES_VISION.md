...
- **PWA**: Polished & Verified. `service-worker.js` caches all assets with relative paths. Fixed registration duplication in `js/app.js` and added `id` to `manifest.json`.
