...
- **PWA**: Fully Polished & Verified (Jan 13). `service-worker.js` caches all assets with relative paths. `manifest.json` includes `id`. Duplicate registration in `js/app.js` removed.
